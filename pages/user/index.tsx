...
//   document.querySelector('input[name="avtnew"]').value = members.find(
//     (u) => u.id == id
//   ).avt;
//   document.querySelector('input[name="msvnew"]').value = members.find(
//     (u) => u.id == id
//   ).msv;
//   document.querySelector('input[name="namenew"]').value = members.find(
//     (u) => u.id == id
//   ).name;
//   document.querySelector('input[name="classnew"]').value = members.find(
//     (u) => u.id == id
//   ).class;
//   document.querySelector('input[name="bannew"]').value = members.find(
//     (u) => u.id == id
//   ).ban;
//   document.querySelector('input[name="rolenew"]').value = members.find(
//     (u) => u.id == id
//   ).role;
...
//         </div>
//       </div>
//       <script src="https://unpkg.com/micromustache@8.0.3/dist/micromustache.umd.js"></script>
//     </>
//   );
// }
