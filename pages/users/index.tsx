    ...
    <div className="App">
      <div className="main-content">
        <div className="btn-add-user">
          <button className="btn mt-28" onClick={handleClick}>
            Add User
          </button>
        </div>
      ...
      {showPopup === true && (
        <div className="popup-add-user">
          <div className="content-add-user">
            <div
              onClick={handleHide}
              className="esc-popup-add bg-stone-600 text-white w-8 text-center h-7 rounded-lg mt-5 ml-5 opacity-60 cursor-pointer hover:opacity-90"
            >
              esc
            </div>
